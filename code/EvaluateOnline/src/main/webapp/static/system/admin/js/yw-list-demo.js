...
(function() {
	...
	$('#ywList').bootstrapTable('hideColumn', 'sex');
	$('#ywList').bootstrapTable('hideColumn', 'id');
})();
/*表格行增加删除函数*/
...
window.actionEvents = {
	'click .mod': function(e, value, row, index) { //修改   
		...
		document.location.href = "/admin/update?number=" + number+"&id="+id;
	},
